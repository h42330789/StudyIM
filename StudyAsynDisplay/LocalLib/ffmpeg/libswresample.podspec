Pod::Spec.new do |s|
    ...
    s.public_header_files = ['FFmpeg-iOS/include/libswresample/**/*.h']
    s.source_files  = ['FFmpeg-iOS/include/libswresample/**/*.h']
    s.ios.vendored_libraries = 'FFmpeg-iOS/lib/libswresample/**/*.a'
