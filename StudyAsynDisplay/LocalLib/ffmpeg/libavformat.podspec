Pod::Spec.new do |s|
    ...
    s.public_header_files = ['FFmpeg-iOS/include/libavformat/**/*.h']
    s.source_files  = ['FFmpeg-iOS/include/libavformat/**/*.h']
    s.ios.vendored_libraries = 'FFmpeg-iOS/lib/libavformat/**/*.a'
