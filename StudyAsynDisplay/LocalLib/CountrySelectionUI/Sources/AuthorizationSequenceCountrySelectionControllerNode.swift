...
public func localizedCountryNamesAndCodes(strings: String) -> [((String, String), String, [Int])] {
    let locale = localeWithStrings(languageCode: strings)
...
public func localeWithStrings(languageCode: String) -> Locale {
...
final class AuthorizationSequenceCountrySelectionControllerNode: ASDisplayNode, UITableViewDelegate, UITableViewDataSource {
    ...
    private let baseLanguageCode: String
    ...
    init(baseLanguageCode: String, displayCodes: Bool, itemSelected: @escaping (((String, String), String, Int)) -> Void) {
       
        self.baseLanguageCode = baseLanguageCode
        self.displayCodes = displayCodes
        self.itemSelected = itemSelected
        
        self.needsSubtitle = baseLanguageCode != "en"
        ...
        let countryNamesAndCodes = localizedCountryNamesAndCodes(strings: baseLanguageCode)
        ...
        self.searchTableView.backgroundColor = .black
        
        self.searchTableView.backgroundColor = .black
        self.searchTableView.separatorColor = .black
        self.searchTableView.backgroundView = UIView()
        self.searchTableView.sectionIndexColor = .black
    ...
    func tableView(_ tableView: UITableView, willDisplayHeaderView view: UIView, forSection section: Int) {
        (view as? UITableViewHeaderFooterView)?.tintColor = .black
